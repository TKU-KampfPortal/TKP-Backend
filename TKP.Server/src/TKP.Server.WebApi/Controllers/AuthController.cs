...
using TKP.Server.WebApi.Controllers;
...
namespace TKP.Server.WebAPI.Controllers
{
    ...
    public class AuthController : BaseController
    {
        ...
        [HttpPost("login")]
        [ProducesResponseType(typeof(ApiResult<List<AuthTokenResponseDto>>), StatusCodes.Status200OK)] // OK with AuthTokenResponseDto
        ...
        [HttpGet("get-me")]
        [Authorize]
        [ProducesResponseType(typeof(ApiResult<List<AuthUserDto>>), StatusCodes.Status200OK)] // OK with AuthUserDto
